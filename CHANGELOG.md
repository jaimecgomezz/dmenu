...
- Prepare the prefix-completition-patch integration

### Added

- Add the prefix-completition-patch
- Add the prefix-completition-patch to docs
...
- Prepare the managed-patch integration

### Added

- Add the managed-patch
- Add the managed-patch to docs
...
- Add support for the scroll-patch in handle utility
